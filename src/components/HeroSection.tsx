    ...
    <div className="relative bg-tradie-navy text-white py-20 px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col items-center mb-8">
          <div className="bg-gradient-to-r from-tradie-orange/20 to-tradie-orange/10 border-2 border-tradie-orange rounded-lg py-3 px-6 w-full md:max-w-fit mx-auto transform hover:scale-105 transition-all duration-300 animate-[pulse_15s_cubic-bezier(0.4,0,0.6,1)_infinite]">
